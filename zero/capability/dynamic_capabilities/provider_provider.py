"""Dynamically synthesized provider for provider."""
...
class ProviderGeneratedProvider(BaseProvider):
    ...
    async def generate_response(
        ...
        **kwargs: Any
        ...
        target_model = model or "provider-default"
        ...
        try:
            ...
            pass
        return f"[PROVIDER Provider] Synthesized response for: {prompt}"
    ...
    async def discover_models(self, force_refresh: bool = False) -> List[DiscoveredModel]:
        return [DiscoveredModel(id="provider-default", display_name="Provider Default Model")]
