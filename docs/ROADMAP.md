...
Phase 1: AI Companion MVP (DONE - Deliverables Verified)
...
### Phase 1: AI Companion MVP (COMPLETE)
- [x] Desktop System Tray App with floating overlay (`Alt+Space`).
- [x] Gemini API Model Router integration (@google/genai).
- [x] Local MCP filesystem (`read_file`, `write_file`, `edit_file`) and terminal tools.
- [x] Local SQLite episodic chat storage (`zero.db`).
- [x] Security Permission Gatekeeper (Level 0–3 risk matrix).
- [x] Windows Auto-Launch integration.
