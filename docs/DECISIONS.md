...
- **Decision**: Build Phases 1 through 9 as a high-velocity TypeScript + Tauri/Electron application. Extract stable core modules into a high-performance Rust microkernel in Phase 10.
