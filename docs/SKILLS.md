...
## 2. React & Desktop Overlay UI
- **IPC Architecture**: The frontend communicates with the backend exclusively via typed IPC commands (`ipcRenderer.invoke('zero:...')`) or event streams.
